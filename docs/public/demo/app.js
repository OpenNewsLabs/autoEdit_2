...
module.exports = Backbone.View.extend({
  ...
  */
  edlUserManualInfo: function(){
    var url = 'https://opennewslabs.github.io/autoEdit_2/user_manual/usage.html#reconnect-in-video-editing-software-of-choice';
    if( window.nw ){
