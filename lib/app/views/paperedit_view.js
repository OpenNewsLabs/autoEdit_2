...
module.exports = Backbone.View.extend({
  ...
  dragStartPapercut: function(e){
    ...
    // TODO: sortout horribel patch. instead of innerHTML get all element as HTML. 
     this.dragSrcElInnerHTML = "<div class='row papercut' draggable='true'>"+e.currentTarget.innerHTML+"</div>";
    ...
    // console.log("e.dataTransfer.getData('text/html')",e.data, e.data.value);
     ...
     //  e.currentTarget is current target element.
      ...
      if (this.dragSrcEl !=  e.currentTarget) {
        ...
        // Making div from string 
        // TODO: could be abstracted as own function.
        // https://stackoverflow.com/questions/3103962/converting-html-string-into-dom-elements
        var parser = new DOMParser();
        var tmpDiv = parser.parseFromString(this.dragSrcElInnerHTML, "text/xml");
        ...
        // document.querySelector(".paperedit").insertBefore(tmpDiv, e.currentTarget);

        // e.currentTarget.parentNode.insertBefore(tmpDiv, e.currentTarget.nextSibling);
        console.log("this.dragSrcElInnerHTML",this.dragSrcElInnerHTML,tmpDiv);
        //https://developer.mozilla.org/en-US/docs/Web/API/Element/insertAdjacentHTML
        e.currentTarget.insertAdjacentHTML('beforebegin', this.dragSrcElInnerHTML);

        // document.querySelector(".papercut").parentNode.insertBefore(document.querySelectorAll(".papercut")[3], document.querySelector(".papercut").nextSibling);
        //document.querySelector(e.currentTarget).parentNode.insertBefore(tmpDiv, document.querySelector(e.currentTarget).nextSibling);
