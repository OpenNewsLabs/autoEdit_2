...
exportEdlJSON: function(){
  ...
  */ 
  ...
  exportToAdobeSequenceInCep: function(){
    ...
    window.__adobe_cep__.evalScript("$._PPP.create_sequence_from_paper_edit('" + JSON.stringify({clips: this.mode.get('events'), sequenceName: this.mode.get('title') })+"')", function (response){
      // mute autoEdit video 
