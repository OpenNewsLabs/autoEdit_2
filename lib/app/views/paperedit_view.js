...
module.exports = Backbone.View.extend({
  ...
  playPapercuts: function(){
   ...
   console.log("playPapercuts/videoSequence",JSON.stringify(videoSequence, null, 4));
   ...
   function playVideoSegments(videoSequence){
    // var videoSequence = videoSequence; 
      // console.log("playVideoSegments",videoSequence);
      if(counter <= videoSequence.length - 1){
        // console.log(counter, videoSequence.length, counter < videoSequence.length);
        ...
        var videoSrc  = videoSequence[counter].src; // generates an exception
        ...
        video.setAttribute("src", videoSrc + "#t="+inPoint+","+outPoint);
        ...
        video.addEventListener("timeupdate", function() {
         if(counter <= videoSequence.length - 1){
          if (video.currentTime >= outPoint) {
            ...
            console.log("videoSrc",counter, videoSrc, videoSequence, videoSequence[counter],videoSequence[counter].src);
