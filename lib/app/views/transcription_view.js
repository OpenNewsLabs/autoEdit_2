...
module.exports = Backbone.View.extend({
    ...
    exportHelper: function(config) {
        ...
        var formBlob = new Blob([fileContent], {
            type: 'text/plain'
        });
     ...
     * @function exportHelper
     */
    nameFileHelper: function(name, ext) {
    ...
    exportEdlChronological: function(e) {
        ...
        var edlSq = {
            ...
            offset: this.model.get('metadata').timecode
        };
        edlSq.events = [];
        ...
        this.exportHelper({
            ...
            fileContent: edl.compose(),
            urlId: '#exportEdlChronological'
        });
    },
    ...
    exportEdlSelectionOrder: function(e) {
        ...
        var selectionsSorted = _.sortBy(selections, function(o) {
            return o.paperCutOrder;
        });
    ...
    expoertCaptionsSrt: function() {
        ...
        this.exportHelper({
            fileName: fileName,
            fileContent: srtFileContent,
            urlId: '#expoertCaptionsSrt'
        });
    },
    ...
    exportTimecodedTranscription: function() {
        ...
        this.exportHelper({
            ...
            fileContent: plainTextTimecoded,
            urlId: '#exportTimecodedTranscription'
        });
    },
    ...
    exportPlainTextEDL: function() {
        ...
        this.exportHelper({
            fileName: textFileName,
            fileContent: tmp,
            urlId: '#exportPlainTextEDL'
        });

        // TODO: move makePlainText outside
    ...
    exportPlainTextEDLSelOrder: function() {
        var paperCuts = this.model.get('highlights');
        var selectionsSorted = _.sortBy(paperCuts, function(o) {
            return o.paperCutOrder;
        });
        ...
        this.exportHelper({
            ...
            urlId: '#exportPlainTextEDLSelOrder'
        });
    ...
    exportPlainTimecodedTextEDL: function() {
        ...
        // TODO: move makeTimecodedPlainText outside
        ...
        this.exportHelper({
            fileName: textFileName,
            fileContent: tmp,
            urlId: '#exportPlainTimecodedTextEDL'
        });
    },
    ...
    exportJsonTranscription: function() {
        ...
        this.exportHelper({
            ...
            fileContent: tmpTranscription,
            urlId: '#exportJsonTranscription'
        });
    },
    ...
    selectingWords: function(e) {
        ...
        for (var i = 0; i < elemCount; i++) {
            ...
            if (element.hasClass('highlight')) {
                ...
                this.model.set({
                    counterForPaperCuts: tmpCounter + 1
                });
        ...
        this.model.set({
            highlights: this.makePaperEdit($('.words').filter('.highlight'), m)
        });
        //save the model
        this.model.save({
            wait: false
