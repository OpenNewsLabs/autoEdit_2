  ...
  */
  ...
  sendTweet: function(){
    ...
    const infoToTweet =  {
      ...
      inputSeconds: timecodesToSeconds(inputElInPointEl.value), 
      durationSeconds: timecodesToSeconds(inputElOutPointEl.value), 
    ...
    if(window.ENV_ELECTRON){
      ...
      window.tweetThatClip(infoToTweet, (err, res) => {
        ...
        console.error('tweet error');
          ...
          if(res.text){
            console.info('tweeted res.text ',res.text );
