...
module.exports = Backbone.View.extend({
  ...
  */
  ...
  setTwitterClipInpoint: function(){
    ...
    inputElInPoint.value  = videoEl.currentTime;
  },
  ...
  setTwitterClipOutpoint: function(){
    ...
    inputElOutPoint.value  = videoEl.currentTime;
    durationEl.value = `${parseFloat(videoEl.currentTime- inputElInPoint.value)} / 2 min`;
  ...
  getTweetText: function(){
    ...
    twitterTextStatusAreaEl.value = getWordsInInterval(inputElInPoint.value,inputElOutPoint.value);
    ...
    function getWordsInInterval(start, end){
      ...
      words.forEach((w)=>{
        if((parseFloat(w.dataset.startTime) > parseFloat(inputElInPoint.value)) && (parseFloat(w.dataset.endTime) <  parseFloat(inputElOutPoint.value))){
  ...
  changeTweetInpointRange: function(evt){
    ...
    inputElInPoint.value = parseFloat(inputElInPoint.value)+tmpRange;
  },
  ...
  sendTweet: function(){
    ...
    inputSeconds: inputElInPointEl.value, 
    durationSeconds: inputElOutPointEl.value, 
