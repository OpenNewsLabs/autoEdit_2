...
var generate = function(config) {
  ...
  var ffmpegPath        = process.cwd() + "/lib/interactive_transcription_generator/bin/ffmpeg";
  // var ffmpegPath        = require('ffmpeg-static').path;
  // var ffprobePath       = require('ffprobe-static').path;
  var ffprobePath        = process.cwd() + "/lib/interactive_transcription_generator/bin/ffprobe";
