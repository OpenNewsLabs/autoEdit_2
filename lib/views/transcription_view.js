...
module.exports = Backbone.View.extend({
   ...
   if(window.frontEndEnviromentNWJS){
    var fs = require("fs");
      fs.writeFileSync(process.env.HOME+"/Desktop/"+fileName, fileContent );
       ...
       // window.nw.Shell.showItemInFolder(process.env.HOME+"/Desktop/"+fileName);
       // window.nw.Shell.openItem(process.env.HOME+"/Desktop/"+fileName);
  ...
  */ 
  edlUserManualInfo: function(){
     if( window.frontEndEnviromentNWJS ){
        window.nw.Shell.openExternal('https://opennewslabs.github.io/autoEdit_2/user_manual/usage.html#reconnect-in-video-editing-software-of-choice');
      }
  },
